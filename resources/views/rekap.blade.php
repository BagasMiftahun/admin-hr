                        ...
                        <div class="col-xs-4 col-md-4 col-lg-4 no-padding">
                            <div class="panel panel-blue panel-widget border-right">
                                <div class="row no-padding">
                                    <div class="large">{{ count(App\Models\EmployesCategory::get()) }}</div>
                                    <div><a href="{{url('/admin/rekap/kelas')}}" class="text-muted">Kategoti Karyawan</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-4 col-md-4 col-lg-4 no-padding">
                            <div class="panel panel-orange panel-widget border-right">
                                <div class="row no-padding">
                                    <div class="large">{{ count(App\Models\Employes::get()) }}</div>
                                    <div><a class="text-muted"href="#">Karyawan</a></div>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-4 col-md-4 col-lg-4 no-padding">
